...
function ManageOpportunityContent({
  ...
  async function handleDelete() {
    if (
      !confirm(
        `Remove "${opportunity?.title}"? This will also delete all applications. This action cannot be undone.`
      )
    )
      return;
           ...
           <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
             ...
             <div className="flex items-center gap-4">
               ...
               <button
                 ...
                 disabled={deleting}
                 className="inline-flex items-center gap-2 rounded-xl border border-rose-500/30 bg-rose-500/10 px-4 py-2.5 text-xs font-bold text-rose-400 hover:bg-rose-500/20 disabled:opacity-50"
               >
                 {deleting ? (
